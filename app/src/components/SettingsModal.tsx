...
export default function SettingsModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" onKeyDown={onKey}>
      ...
      <div className="relative bg-white dark:bg-[#252526] border border-neutral-300 dark:border-[#323233] rounded shadow-xl w-[560px] max-w-[95vw] p-4">
        ...
        <div className="space-y-4">
          <div>
            ...
            <select className="w-full px-2 py-1 rounded border border-neutral-300 dark:border-[#323233] bg-white dark:bg-[#1e1e1e] text-sm" value={local.overwritePolicy}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input className="w-full px-2 py-1 rounded border border-neutral-300 dark:border-[#323233] bg-white dark:bg-[#1e1e1e] text-sm" type="number" min={1} max={32}
            ...
            <div>
              ...
              <input className="w-full px-2 py-1 rounded border border-neutral-300 dark:border-[#323233] bg-white dark:bg-[#1e1e1e] text-sm" type="number" min={5} max={128}
            ...
            <div>
              ...
              <input className="w-full px-2 py-1 rounded border border-neutral-300 dark:border-[#323233] bg-white dark:bg-[#1e1e1e] text-sm" type="number" min={8} max={128}
          ...
          <div>
            ...
            <input className="w-full px-2 py-1 rounded border border-neutral-300 dark:border-[#323233] bg-white dark:bg-[#1e1e1e] text-sm" type="number" min={0}
        ...
        <div className="mt-4 flex justify-end gap-2">
          <button className="px-3 py-1 text-sm rounded bg-neutral-200 dark:bg-[#2a2d2e] hover:bg-neutral-300 dark:hover:bg-[#323334] text-neutral-700 dark:text-[#cccccc]" onClick={closeSettings}>Cancel</button>
          <button className="px-3 py-1 text-sm rounded bg-[#0e639c] hover:bg-[#1177bb] text-white" onClick={save}>Save</button>
        </div>
      </div>
    </div>
  )
