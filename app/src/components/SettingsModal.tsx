...
export default function SettingsModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" onKeyDown={onKey}>
      ...
      <div className="relative bg-white dark:bg-neutral-900 border rounded shadow-xl w-[560px] max-w-[95vw] p-4">
        ...
        <div className="space-y-4">
          <div>
            ...
            <select className="w-full px-2 py-1 rounded border bg-white/70 dark:bg-neutral-800 text-sm" value={local.overwritePolicy}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input className="w-full px-2 py-1 rounded border bg-white/70 dark:bg-neutral-800 text-sm" type="number" min={1} max={32}
            ...
            <div>
              ...
              <input className="w-full px-2 py-1 rounded border bg-white/70 dark:bg-neutral-800 text-sm" type="number" min={5} max={128}
            ...
            <div>
              ...
              <input className="w-full px-2 py-1 rounded border bg-white/70 dark:bg-neutral-800 text-sm" type="number" min={8} max={128}
          ...
          <div>
            ...
            <input className="w-full px-2 py-1 rounded border bg-white/70 dark:bg-neutral-800 text-sm" type="number" min={0}
        ...
        <div className="mt-4 flex justify-end gap-2">
          <button className="px-3 py-1 text-sm rounded bg-neutral-200 dark:bg-neutral-800" onClick={closeSettings}>Cancel</button>
          <button className="px-3 py-1 text-sm rounded bg-blue-600 text-white" onClick={save}>Save</button>
        </div>
      </div>
    </div>
  )
